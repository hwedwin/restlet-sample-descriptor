...
/**
 * Defines the contract of the "Company" resource.<br>
 ...
 * <ul>
 * <li>name of the HTTP method, using the Restlet based annotations (in this
...
public interface CompanyResource {
    ...
    @Get
    Company getCompany() throws NotFoundException;
    ...
    @Put
    Company update(Company company) throws NotFoundException,
            BadEntityException;
